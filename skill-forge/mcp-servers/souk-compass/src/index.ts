      ...
      inputSchema: {
        ...
        properties: {
          action: {
            ...
            description:
              "Action to perform. Default is 'check'.",
          },
        },
      },
    },
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          collection: {
            type: "string",
            description: "Target Solr collection (default: user doc collection).",
          },
        },
      },
    },
      ...
      inputSchema: {
        ...
        properties: {
          ...
          minScore: {
            type: "number",
            description:
              "Minimum relevance score threshold (default: 0.4).",
          },
          persist: {
            type: "boolean",
            description:
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    ...
    switch (request.params.name) {
      case "compass_setup":
        result = await handleCompassSetup(args as any, toolContext);
        break;
      case "compass_index_artifacts":
        result = await handleCompassIndexArtifacts(args as any, toolContext);
        break;
      case "compass_search":
        result = await handleCompassSearch(args as any, toolContext);
        break;
      case "compass_index_document":
        result = await handleCompassIndexDocument(args as any, toolContext);
        break;
      case "compass_status":
        result = await handleCompassStatus(args as any, toolContext);
        break;
      case "compass_health":
        result = await handleCompassHealth(args as any, toolContext);
        break;
      case "compass_reindex":
        result = await handleCompassReindex(args as any, toolContext);
        break;
      case "compass_recall":
        result = await handleCompassRecall(args as any, toolContext);
        break;
      case "compass_remember":
        result = await handleCompassRemember(args as any, toolContext);
        break;
      case "compass_recall_memory":
        result = await handleCompassRecallMemory(args as any, toolContext);
        break;
      case "compass_profile_workspace":
        result = await handleCompassProfileWorkspace(args as any, toolContext);
        break;
      default:
