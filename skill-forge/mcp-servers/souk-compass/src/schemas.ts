...
// Inferred types for each tool input
export type CompassSetupInput = z.infer<typeof ToolInputSchemas.compass_setup>;
export type CompassIndexArtifactsInput = z.infer<
  typeof ToolInputSchemas.compass_index_artifacts
>;
export type CompassSearchInput = z.infer<
  typeof ToolInputSchemas.compass_search
>;
export type CompassIndexDocumentInput = z.infer<
  typeof ToolInputSchemas.compass_index_document
>;
export type CompassStatusInput = z.infer<
  typeof ToolInputSchemas.compass_status
>;
export type CompassHealthInput = z.infer<
  typeof ToolInputSchemas.compass_health
>;
export type CompassReindexInput = z.infer<
  typeof ToolInputSchemas.compass_reindex
>;
export type CompassRecallInput = z.infer<
  typeof ToolInputSchemas.compass_recall
>;
export type CompassRememberInput = z.infer<
  typeof ToolInputSchemas.compass_remember
>;
export type CompassRecallMemoryInput = z.infer<
  typeof ToolInputSchemas.compass_recall_memory
>;
export type CompassProfileWorkspaceInput = z.infer<
