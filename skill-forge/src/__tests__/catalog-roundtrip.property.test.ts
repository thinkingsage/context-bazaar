...
const categoryArb = fc.constantFrom(...CATEGORIES) as fc.Arbitrary<CatalogEntry["categories"][number]>;

const maturityArb = fc.constantFrom("experimental", "beta", "stable", "deprecated") as fc.Arbitrary<CatalogEntry["maturity"]>;
...
const catalogEntryArb: fc.Arbitrary<CatalogEntry> = fc.record({
  ...
  type: fc.constantFrom("skill", "power", "rule", "workflow", "agent", "prompt", "template", "reference-pack") as fc.Arbitrary<CatalogEntry["type"]>,
